            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <!-- <div class="card-body" style="margin: -20px 0 0 -12px"> -->
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    <div class="stat-icon dib flat-color-1">
                                        <!-- <i class="pe-7s-cash"></i> -->
                                        <i class="fas fa-gamepad"></i>
                                        <!-- <img class="img-fluid" src="<?= base_url('./images/pubg-mobile.png') ?>" alt="pubg-mobile"> -->
                                    </div>
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">PUBGM</span></div>
                                            <div class="stat-heading">PUBG-Mobile</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
